      ...
      <Link to={`/post/${savedpost._id}`}>
        ...
        <div className="savepostcard-content">
          <div className="savepostcard-contentuserinfo">
            <img
              className="savepostcard-contentuserinfoimage"
              src={savedpost.user?.image}
              alt=""
            />
            <div className="savepostcard-contentinfodetail">
              <h5 className="savepostcard-contentinfodetailfullname">
                {savedpost.user?.fullname}
              </h5>
              <small className="savepostcard-contentinfodetailusername">
          ...
          <div className="savedpostcard-contentend">
            <div className="savedpostcard-contentenditem">
              <h6 className="savedpostcard-contentenditemtext">
            ...
            <div className="savedpostcard-contentenditem">
              <h6 className="savedpostcard-contentenditemtext">
                {savedpost.commentss.length}
              </h6>
              <CommentIcon
                style={{
                  color: savedpost.commentss.length === 0 ? "black" : "gray",
                }}
              />
            </div>
          </div>
          <div className="savedpostcard-contentendtime">
            <small className="savedpostcard-contentendtimetext">
              Post Created At:
            </small>
            <small className="savedpostcard-contentendtimeformat">
